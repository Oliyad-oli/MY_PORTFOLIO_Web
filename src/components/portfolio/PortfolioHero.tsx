...
import { ArrowDown, Terminal, Sparkles, FileDown } from "lucide-react";
...
export function PortfolioHero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      />
      <motion.div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-neon-purple/5 blur-3xl animate-morph" />
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-bold mb-6 leading-tight">
              ...
              <span className="text-gradient">Oliad Dandena</span>
            </h1>
          </motion.div>
          ...
          >
            I craft digital experiences that blend creativity with cutting-edge
            technology. Specializing in React, Node.js, and modern web
            technologies.
          </motion.p>
          ...
          >
            ...
            >
              ...
              <motion.div className="absolute inset-0 bg-gradient-to-r from-neon-cyan to-neon-magenta opacity-0 group-hover:opacity-100 transition-opacity" />
            </Button>
            ...
            >
              <FileDown className="w-5 h-5 mr-2 group-hover:text-primary transition-colors" />
              Download CV
            </Button>
          </motion.div>
